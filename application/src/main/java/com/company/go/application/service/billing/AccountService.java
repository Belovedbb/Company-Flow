...
public class AccountService implements AccountUseCase {
    ...
    AccountService(UpdatePerformanceAccountPort performanceAccountStore, UpdatePurchaseOrderAccountPort purchaseOrderAccountStore, UpdateProductAccountPort productAccountStore){
        this.performanceAccountStore = performanceAccountStore;
        this.purchaseOrderAccountStore = purchaseOrderAccountStore;
        this.productAccountStore = productAccountStore;
    }
